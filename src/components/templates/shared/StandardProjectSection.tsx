...
const StandardProjectSection: React.FC<ProjectSectionProps> = ({ projects, globalSettings, showTitle = true, TitleComponent }) => {
    ...
    return (
        <SectionWrapper sectionId="projects" style={{ marginTop: `${globalSettings?.sectionSpacing || 24}px` }}>
            <TitleComponent type="projects" globalSettings={globalSettings} showTitle={showTitle} />
...
export default StandardProjectSection;
