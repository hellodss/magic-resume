...
const StandardExperienceSection: React.FC<ExperienceSectionProps> = ({ experiences, globalSettings, showTitle = true, TitleComponent }) => {
    ...
    return (
        <SectionWrapper sectionId="experience" style={{ marginTop: `${globalSettings?.sectionSpacing || 24}px` }}>
            <TitleComponent type="experience" globalSettings={globalSettings} showTitle={showTitle} />
...
export default StandardExperienceSection;
